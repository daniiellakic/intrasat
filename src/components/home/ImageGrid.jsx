...
const ImageGrid = () => {
  return (
    <div className='bg-white max-w-[1240px] mx-auto py-16 px-4' id='imageGrid'>
        <h1 className=' text-[#000000] md:text-4xl sm:text-3xl text-2xl text-center uppercase p-2 py-8 font-bold underline decoration-yellow-400 decoration-4'>Vårt Jobb</h1>
