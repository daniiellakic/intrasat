...
const Footer = () => {
  return (
    <div>
        <div className='bg-[#000300] w-full mt-16 z-40 grid lg:grid-cols-4 md:flex-row  md:space-x-1 text-center justify-center' id='contact'>
           <Link to='/about' className='p-2 z-10 text-gray-500 w-[200px] uppercase font-bold mx-auto py-3'>
           <button>Om Oss</button>
           </Link>
           <Link to='/service' className='p-2 z-10 text-gray-500 w-[200px] uppercase font-bold mx-auto py-3'>
           <button>Våra tjänster</button>
           </Link>
           <Link to='/imageGrid' className='p-2 z-10 text-gray-500 w-[200px] uppercase font-bold mx-auto py-3'>
           <button>Vårt Jobb</button>
           </Link>
           <Link to='/contactForm' className='p-2 z-10 text-gray-500 w-[200px] uppercase font-bold mx-auto py-3'>
